...
namespace Injectikus
{
    ...
    /// </summary>
    public class DefaultBinderFactory : BaseBinderFactory
    {
        ...
        public DefaultBinderFactory(IContainer container) : base(container)
        {
        ...
        public override IBinder GetBinder(Type type)
        {
        ...
        public override IBinder<TargetT> GetBinder<TargetT>() where TargetT : class
        {
